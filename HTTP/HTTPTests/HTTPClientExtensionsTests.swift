...
final class HTTPClientExtensionsTests: XCTestCase {
    ...
    override class func setUp() {
        super.setUp()
        Container.registerShared(MockHTTPClient())
        Container.registerUnique(HTTPClient.self) { $0.resolve(MockHTTPClient.self) }
    }
    
    override func tearDown() {
        super.tearDown()
        mockHTTPClient.result = nil
    ...
    func testExecute_forValidRequest_andSuccessResponse_shouldReturnExepctedResponse() async throws {
        ...
        mockHTTPClient.result = .success(exepctedResponse)
    ...
    func testExecute_forValidRequest_andFailureResponse_shouldThrowError() async {
        mockHTTPClient.result = .failure(.urlError(URLError(.cannotFindHost)))
    ...
    func testExecute_forValidRequest_andSuccessResponse_shouldFinishWithSuccess() async {
        ...
        mockHTTPClient.result = .success(Response(httpURLResponse: exepctedResponse!, data: Data()))
    ...
    func testExecute_forValidRequest_andValidBody_shouldReturnValidResponse() async throws {
        ...
        mockHTTPClient.result = .success(Response(httpURLResponse: response!, data: exepctedResponse.data))
